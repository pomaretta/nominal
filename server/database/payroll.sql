...
INSERT INTO nominal_dev.payroll (company,agreement,employee,date_from,date_to,date_total_days,base_salary,employee_apportion,apportion,salary_kind,total_earned,cc_percentage,cc_value,unemployment_percentage,unemployment_value,training_percentage,training_value,oh_percentage,oh_percentage,eh_percentage,eh_value,total_aportations,irpf_percentage,irpf_value,advance_pays,sk_reduction,other_reduction,total_deduction,total_to_receive) VALUES 
...
-- INSERT INTO nominal_dev.payroll_complement (payroll,title,salarial,value_original,value_percentage,value)